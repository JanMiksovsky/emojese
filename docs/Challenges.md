...
|buy|326|Numerous emoji like 💵 Banknote with Dollar Sign express money, but not specifically the spending of it. There is also 🛒 Shopping Cart, but that focuses on the act of shopping instead of the purchase. Emojese uses 💵 Dollar Banknote, ↹ Leftwards Arrow To Bar Over Rightwards Arrow To Bar, and ⬚ Dotted Square to denote exchanging money to acquire a thing. See also “sell”.|💵↹⬚|<img src="../static/experimental/noun_buy_1382663.svg" style="width: 200px">|
...
|care (verb)|246|There is 🧑‍⚕️ Health Worker, but nothing to direct represent one person caring for another — applying a bandage or listening with a stethoscope, say.|🧑‍⚕️⟿|<img src="../static/experimental/noun-caring-169351.svg" style="width: 200px">|
